...
label_die1 = Label(root, font="Arial 10 bold", bg="red", width=5)
label_die1.grid(row=1, column=0)

label_die2 = Label(root, font="Arial 10 bold", bg="red", width=5)
label_die2.grid(row=1, column=1)

label1 = Label(root, text="roll count = ")
label1.grid(row=3, column=0)

label2 = Label(root, textvariable=roll_count)
