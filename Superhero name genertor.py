...
#Label
answer = Label(root, text="", font=("Arial", 9, "bold"))
...
textbox = Entry(root)
textbox.grid(row=6, column=0, padx=10)
...
my_combobox.grid(row=8, column=0, padx=10)
